...
// Sumber: SKB 3 Menteri No. 1497/2025, 2/2025, 5/2025
...
export const HOLIDAY_MAP = Object.fromEntries(HOLIDAYS_2026.map(h => [h.tanggal, h]))
...
export function isHoliday(isoDate) {
    return !!HOLIDAY_MAP[isoDate]
}

export function getHoliday(isoDate) {
    return HOLIDAY_MAP[isoDate] || null
}
